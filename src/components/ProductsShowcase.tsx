...
const products = [
    { name: 'Octa Salary Advance Loan', image: '/woman.jpg' },
    { name: 'Octa Asset Finance Loan', image: '/woman.jpg' },
    { name: 'Octa Biashara Loan', image: '/woman.jpg' },
    { name: 'Octa School Fees Loan', image: '/woman.jpg' },
    { name: 'Octa SME Loan', image: '/woman.jpg' },
    { name: 'Octa Emergency Loan', image: '/woman.jpg' },
];
                ...
                <div className="mt-12">
                    ...
                    >
                        ...
                        <div className="flex items-center">
                            <span className="mr-2">Get Quick & Flexible Loans to Bridge Your Financial Needs</span>
